let platform; // Déclaration de la variable platform à un niveau supérieur
let userAgent; // Déclaration de la variable userAgent à un niveau supérieur
...
const url = "https://api.ipgeolocation.io/ipgeo?apiKey=9ed8eefc86024c67b341a5ace0b43e1c&ip=44.210.96.181";

httpGetAsync(url, function (responseText) {
    const data = JSON.parse(responseText);
    const country = data.country_name;
    platform = data.platform; // Affectation de la valeur à la variable platform
    const city = data.city;
    const region = data.region;
    const isp = data.isp;
    userAgent = window.navigator.userAgent; // Affectation de la valeur à la variable userAgent
